...
async def run_zas_chat_turn(
	...
	if not _tools_authorized(user_id, org_id):
		raise PermissionError("Unauthorized to invoke tools")
	...
	total_tokens_used = zas_result_temp.context_wrapper.usage.total_tokens
	return reply_text, updated_history, total_tokens_used
